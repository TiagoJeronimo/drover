...
const VehicleDisplay = ({ vehicle, pricingConsumer }) => (
  <div className="vehicleDisplay-mainContainer col-xs-12 col-sm-6 col-lg-4">
    <div className="vehicleDisplay-container">
      <div className="vehicleDisplay-headerInfo">
        <div className="vehicleDisplay-pricingText">{`£${pricingConsumer}`}</div>
        <div className="vehicleDisplay-pricingSubtext">A month</div>
      </div>
      <img
        src={vehicle.stock_image.main_image_url}
        alt="Vehicle"
        className="vehicleDisplay-vehicleImage"
      />
